...
3. Before first deploy, add these 4 Environment Variables (Project → Settings → Environment Variables):
   - `PODIO_APP_ID` = `21529060`
   - `PODIO_APP_TOKEN` = `5a1bd9f52c01495e9b852851055fea86`
   - `PODIO_CLIENT_ID` = `booking-page`
   - `PODIO_CLIENT_SECRET` = `yd8X3JwFj5fXHTfufh6EGwPcq7kgzFmKEcNtIZsuJtGq8VkNCyvTCAWvdG0qKxFQ`
